...
Plans:
- [ ] 11-01: Fix frontend lint errors and remove obvious warning-level debt in critical pages
- [ ] 11-02: Re-verify frontend test and build flows after lint cleanup
...
Plans:
- [ ] 12-01: Add CI workflow for backend tests and frontend lint/test/build gates
- [ ] 12-02: Align docs and naming with the v1.2 hardening milestone truth
