...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 02-01-01 | 01 | 1 | FEAI-01 | T-02-01 / — | AI page file/export is removed so no dead route target remains | static grep | `powershell -NoProfile -Command "if (Test-Path 'frontend/src/pages/AIAssistant.tsx') { exit 1 }; rg -n 'AIAssistant' frontend/src/pages/index.ts"` | ✅ | ⬜ pending |
